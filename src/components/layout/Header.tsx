...
export default function Header() {
  ...
  return (
    <header className="h-16 bg-vintage-paper border-b-2 border-dashed border-vintage-border flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-full bg-vintage-brown flex items-center justify-center border-2 border-vintage-dark">
